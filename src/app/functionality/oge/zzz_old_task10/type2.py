...
class Type2(Task10Old):
    ...
    def category(self):
        return "Анализ алгоритмов - Подсчет количества"
...
class SubtypeA(Type2):
    ...
    def __init__(self):
        ...
        dat = [median+randint(-4, 4) for i in range(self._length)]
        m = 0
